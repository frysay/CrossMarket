...
public class MainAdvertiseArrayAdapter extends BaseAdapter {  
	...
	public MainAdvertiseArrayAdapter(Context context, List<ItemDB> items) {  
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {    
		...
		ib_category.setImageResource(items.get(position).getImage());
